...
const converterCategories = [
  ...
  },
  {
    ...
    converters: [
      { name: 'KG to LBS', href: '/kg-to-lbs', popular: true },
      { name: 'LBS to KG', href: '/lbs-to-kg', popular: true },
  ...
  },
  {
    ...
    converters: [
      { name: 'KMH to MPH', href: '/kmh-to-mph', popular: true },
      { name: 'MPH to KMH', href: '/mph-to-kmh', popular: true },
