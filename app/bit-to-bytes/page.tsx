...
export const metadata: Metadata = {
  title: 'Bits to Bytes Converter – Convert bit to B | Free Tool',
  description: 'Convert bits to bytes instantly. 1 byte = 8 bits. Free online converter with accurate results, conversion formula, and common data storage examples.',
  keywords: 'bits to bytes, bit to B, convert bits to bytes, data storage converter, digital units',
  openGraph: {
    title: 'Bits to Bytes Converter – Convert bit to B',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          ...
          <h1 className="hero-gradient text-4xl font-bold mb-4">Bits to Bytes Converter</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Bits to Bytes</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>8 bits = 1 B</li>
                <li>80 bits = 10 B</li>
                <li>800 bits = 100 B</li>
                <li>8000 bits = 1000 B</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>8 bits - Single byte</li>
                <li>64 bits - Double precision</li>
                <li>8192 bits - 1 KB</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            <h3 className="section-title">How to Use the Bits to Bytes Converter</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Type the bits value you want to convert in the input field</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How to convert bits to bytes?</h4>
              <p className="text-sm text-gray-600">Divide the number of bits by 8. For example: 800 bits ÷ 8 = 100 bytes.</p>
            </div>
            <div className="card p-6">
