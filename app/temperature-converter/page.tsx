...
export default function TemperatureConverterLandingPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      {/* Hero Section */}
      <section className="bg-linear-to-r from-red-600 to-orange-600 text-white py-16">
      ...
      {/* CTA Section */}
      <section className="py-16 bg-linear-to-r from-red-600 to-orange-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Convert Temperature Units Now</h2>
          <p className="text-xl mb-8">Use our free online temperature converter for instant, accurate results</p>
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-2xl max-w-2xl mx-auto">
            <ConverterCard category="temperature" />
          </div>
        </div>
